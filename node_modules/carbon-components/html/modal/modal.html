...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-226b7ue9usq">Show
  modal</button>

<div data-modal id="modal-226b7ue9usq" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-226b7ue9usq-label" aria-describedby="modal-226b7ue9usq-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-226b7ue9usq-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-226b7ue9usq-heading">Modal heading</p>

...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-jrbwhv0s06">Show
  modal</button>

<div data-modal id="modal-jrbwhv0s06" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-jrbwhv0s06-label" aria-describedby="modal-jrbwhv0s06-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--xs">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-jrbwhv0s06-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-jrbwhv0s06-heading">Modal heading</p>

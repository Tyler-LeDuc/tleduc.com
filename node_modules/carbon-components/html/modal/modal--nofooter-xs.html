...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-3jlhdt386up">Show
  modal</button>

<div data-modal id="modal-3jlhdt386up" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-3jlhdt386up-label" aria-describedby="modal-3jlhdt386up-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--xs">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-3jlhdt386up-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-3jlhdt386up-heading">Modal heading</p>

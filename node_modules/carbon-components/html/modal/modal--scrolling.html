...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-nuzgf1pfa9a">Show
  modal</button>

<div data-modal id="modal-nuzgf1pfa9a" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-nuzgf1pfa9a-label" aria-describedby="modal-nuzgf1pfa9a-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-nuzgf1pfa9a-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-nuzgf1pfa9a-heading">Modal heading</p>

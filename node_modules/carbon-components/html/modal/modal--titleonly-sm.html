...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-amlxbhumn4j">Show
  modal</button>

<div data-modal id="modal-amlxbhumn4j" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-amlxbhumn4j-label" aria-describedby="modal-amlxbhumn4j-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--sm">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-amlxbhumn4j-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-amlxbhumn4j-heading">Passive modal title as the message. Should be direct and 3 lines or less.</p>

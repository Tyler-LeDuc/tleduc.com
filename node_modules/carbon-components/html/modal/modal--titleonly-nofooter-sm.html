...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-69gk7e4rq5x">Show
  modal</button>

<div data-modal id="modal-69gk7e4rq5x" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-69gk7e4rq5x-label" aria-describedby="modal-69gk7e4rq5x-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--sm">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-69gk7e4rq5x-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-69gk7e4rq5x-heading">Passive modal title as the message. Should be direct and 3 lines or less.</p>

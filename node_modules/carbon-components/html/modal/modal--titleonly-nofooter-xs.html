...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-deg0orjx8qm">Show
  modal</button>

<div data-modal id="modal-deg0orjx8qm" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-deg0orjx8qm-label" aria-describedby="modal-deg0orjx8qm-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--xs">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-deg0orjx8qm-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-deg0orjx8qm-heading">Passive modal title as the message. Should be direct and 3 lines or less.</p>

...
<button class="bx--btn bx--btn--danger" type="button" data-modal-target="#modal-b1b3ls87qc6">Show
  modal</button>

<div data-modal id="modal-b1b3ls87qc6" class="bx--modal bx--modal--danger" role="dialog"
  aria-modal="true" aria-labelledby="modal-b1b3ls87qc6-label" aria-describedby="modal-b1b3ls87qc6-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-b1b3ls87qc6-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-b1b3ls87qc6-heading">Modal heading</p>

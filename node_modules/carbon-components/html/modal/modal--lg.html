...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-pm3cihwysv">Show
  modal</button>

<div data-modal id="modal-pm3cihwysv" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-pm3cihwysv-label" aria-describedby="modal-pm3cihwysv-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--lg">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-pm3cihwysv-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-pm3cihwysv-heading">Modal heading</p>

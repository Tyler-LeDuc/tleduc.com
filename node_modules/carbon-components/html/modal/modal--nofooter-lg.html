...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-1uy4zlfoj3s">Show
  modal</button>

<div data-modal id="modal-1uy4zlfoj3s" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-1uy4zlfoj3s-label" aria-describedby="modal-1uy4zlfoj3s-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--lg">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-1uy4zlfoj3s-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-1uy4zlfoj3s-heading">Modal heading</p>

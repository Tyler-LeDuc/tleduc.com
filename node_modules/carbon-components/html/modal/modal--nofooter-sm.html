...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-otqmvlu86a">Show
  modal</button>

<div data-modal id="modal-otqmvlu86a" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-otqmvlu86a-label" aria-describedby="modal-otqmvlu86a-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--sm">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-otqmvlu86a-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-otqmvlu86a-heading">Modal heading</p>

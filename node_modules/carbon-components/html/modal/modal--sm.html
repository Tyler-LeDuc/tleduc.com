...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-eragsaxl1pq">Show
  modal</button>

<div data-modal id="modal-eragsaxl1pq" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-eragsaxl1pq-label" aria-describedby="modal-eragsaxl1pq-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--sm">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-eragsaxl1pq-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-eragsaxl1pq-heading">Modal heading</p>

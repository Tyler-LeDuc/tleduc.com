...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-yfba67jnorr">Show
  modal</button>

<div data-modal id="modal-yfba67jnorr" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-yfba67jnorr-label" aria-describedby="modal-yfba67jnorr-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-yfba67jnorr-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-yfba67jnorr-heading">Modal heading</p>
